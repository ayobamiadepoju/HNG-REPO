...
## 📦 Project Structure
```
src/ ├── main/ │   ├── java/ │   │   └── hng/backend/task3/fashionAiAgent/ │   │       ├── FashionAiAgentApplication.java │   │       ├── AgentFactory.java │   │       ├── TelexWebhookController.java │   │       └── TelexMessage.java
```
...
👤 Author
Ayobami – HNG Stage 3 Backend Task
